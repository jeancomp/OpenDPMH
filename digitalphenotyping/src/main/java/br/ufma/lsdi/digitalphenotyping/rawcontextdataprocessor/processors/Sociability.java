...
//    void receive(String nameSensor, String startDate, String endDate, int availableAttributes, List<String> availableAttributesList, double[] rawContextData,IBinder ibinder);
//
