...
* <i>PhenotypeComposer</i>: service responsible for creating digital phenotype objects to be distributed via CDDL. To enable data buffer, this component works in three different modes:
