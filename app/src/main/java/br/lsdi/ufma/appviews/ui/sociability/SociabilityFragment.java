package br.lsdi.ufma.appviews.ui.sociability;
...
public class SociabilityFragment extends Fragment{
    ...
    private SociabilityViewModel sociabilityViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        sociabilityViewModel = ViewModelProviders.of(this).get(SociabilityViewModel.class);
